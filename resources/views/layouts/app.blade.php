...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/fonts/font-awesome-4.3.0/css/font-awesome.min.css') }}">
                        ...
                        <div class="widget">
                            ...
                            <div class="twitter-widget">
                                <ul class="latest-tweets">
                                    <li>
                                        <p><a href="#" title="">@Mark</a> Lorem ipsum dolor sit amet,
                                            consectetur adipiscing elit. Integer lorem quam.</p>
                                        <span>2 hours ago</span>
                                    </li>
                                    <li>
                                        <p><a href="#" title="">@Envato</a> Lorem ipsum dolor sit amet,
                                            consectetur adipiscing elit. Integer lorem quam.</p>
                                        <span>2 hours ago</span>
                                    </li>
                                </ul><!-- end latest-tweet -->
                            ...
                            <ul class="popular-courses">
                                <li>
                                    <a href="single-course.html" title=""><img class="img-thumbnail"
                                            src="{{ asset('assets/upload/service_01.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="single-course.html" title=""><img class="img-thumbnail"
                                            src="{{ asset('assets/upload/service_02.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="single-course.html" title=""><img class="img-thumbnail"
                                            src="{{ asset('assets/upload/service_03.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="single-course.html" title=""><img class="img-thumbnail"
                                            src="{{ asset('assets/upload/service_04.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="single-course.html" title=""><img class="img-thumbnail"
                                            src="{{ asset('assets/upload/service_05.png') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="single-course.html" title=""><img class="img-thumbnail"
                                            src="{{ asset('assets/upload/service_06.png') }}" alt=""></a>
                                </li>
                            </ul>
                        </div><!-- end widget -->
                    </div><!-- end col -->
                    ...
                    <div class="col-md-3 col-md-6 col-xs-12">
                        <div class="widget">
                            ...
                            <ul class="contact-details">
                                ...
                                <li><i class="fa fa-home"></i> Envato INC 22 Elizabeth Str. Melbourne. Victoria 8777.
                                </li>
                            </ul>
